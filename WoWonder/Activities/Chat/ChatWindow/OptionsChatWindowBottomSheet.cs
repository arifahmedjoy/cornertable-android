    ...
    public class OptionsChatWindowBottomSheet : BottomSheetDialogFragment 
    {
        ...
        private void ImgButtonOnClick(object sender, EventArgs e, string reactText)
        {
            try
            {
                ...
                if (DataMessageObject.Reaction.IsReacted != null && !DataMessageObject.Reaction.IsReacted.Value)
                {
                ...
                else if (Page == "GroupChatWindow")
                {
                    ...
                    if (dataClass != null)
                    {
                        ...
                        GroupChatWindowContext?.MAdapter.NotifyItemChanged(ChatWindowContext.MAdapter.DifferList.IndexOf(dataClass));
                    }
                } 
                else if (Page == "PageChatWindow")
                {
                    ...
                    if (dataClass != null)
                    {
                        ...
                        PageChatWindowContext?.MAdapter.NotifyItemChanged(ChatWindowContext.MAdapter.DifferList.IndexOf(dataClass));
                    }
                } 
