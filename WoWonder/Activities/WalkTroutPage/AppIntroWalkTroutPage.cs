        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
               ...
               var fullGlideRequestBuilder = Glide.With(this).AsDrawable().SetDiskCacheStrategy(DiskCacheStrategy.Automatic).SkipMemoryCache(true).Override(200);
                ...
                stickerList.AddRange(Stickers.StickerList7);
                stickerList.AddRange(Stickers.StickerList8);
                stickerList.AddRange(Stickers.StickerList9);
                stickerList.AddRange(Stickers.StickerList10);
                stickerList.AddRange(Stickers.StickerList11);
